  ...
  return (
    <div className="bg-[#090909] text-white">
      ...
      <div className="flex items-start -my-1">
        <Link href="/">
          <CustomImage src="/images/logo_joon_white.png" className="h-3 md:h-4 lg:h-5 w-auto" />
        </Link>
      ...
      <div className="flex flex-col h-screen items-center">
        <div className="h-32 md:h-48 lg:h-56" />
          <div className="font-hrot text-center md:text-lg lg:text-xl">
            My Norm
          </div>
          <div className="h-10" />
          <div className="font-extralight w-10/12 md:3/4 lg:w-1/2 text-center md:text-lg lg:text-xl leading-relaxed bg-gradient-to-t from-[#ffcde5] to-white text-transparent bg-clip-text">
