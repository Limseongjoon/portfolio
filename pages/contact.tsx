...
const Page = () => {
  return (
    <div className="bg-[#f6fe55] bg-gradient-to-t from-[#f8ff34]">
      ...
      <div className="flex items-start">
        ...
        <div className="flex items-end gap-6 md:gap-10 lg:gap-12 -my-[4px] lg:-my-1">
          <Link
            href="/about"
            className="font-hrot text-[#ae3cff] text-2xs md:text-xs lg:text-sm"
          >
            ABOUT
          </Link>
          <Link
      ...
      <div className="flex flex-col h-screen items-center">
        <div className="h-36 md:h-48 lg:h-56" />
          <div className="font-hrot text-[#ae3cff] text-center text-lg md:text-xl lg:text-2xl">
            Contact
          </div>
          <div className="h-4" />
          <div className="text-center text-[#ae3cff] font-extralight md:text-lg">
          Please feel free to contact me :{')'}<br></br>
          I will get back to you as soon as possible.
          </div>
        <div className="h-10" />
        <div className="font-hrot text-[#ae3cff] text-center text-sm md:text-base">
          <a
        ...
        <div className="grow" />
        <div className="h-36" />
        <div className="h-24 text-[#ae3cff] text-center text-xs md:text-sm lg:text-base">
