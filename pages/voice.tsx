  ...
  return (
    <div className="bg-white text-black w-screen h-screen">
      ...
      <div className="bg-white text-black flex flex-col h-screen items-center">
        ...
        <div>
          <CustomImage
            src="/images/wearabledevice_main.jpg"
            className="w-screen"
          />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
        ...
        <div>
          <div className="h-1" />
          <CustomImage src="/images/paper_main.png" className="w-screen" />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
            <div className="flex flex-row w-full items-baseline">
              <div className="h-6" />
        ...
        <div>
          <CustomImage src="/images/genesis_main.png" className="w-screen" />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
            <div className="flex flex-row w-full items-baseline">
              <div className="h-6" />
        ...
        <div>
          <CustomImage src="/images/horror.jpg" className="w-screen" />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
            <div className="flex flex-row w-full items-baseline">
              <div className="h-6" />
        ...
        <div>
          <div className="md:hidden">
            <div className="border-t-[0.5px] border-black opacity-60 mx-4 lg:mx-10" />
            <CustomImage
              src="/images/unfamiliar_main.jpg"
              className="w-screen lg:px-4 xl:px-16"
            />
            <div className="border-b-[0.5px] border-black opacity-60 mx-4 lg:mx-10" />
            <div className="h-6" />
        ...
        <div>
          <div className="h-1" />
          <CustomImage src="/images/symmetry.png" className="w-screen" />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
            <div className="flex flex-row w-full items-baseline">
              <div className="h-6" />
        ...
        <div>
          <CustomImage src="/images/photo_main.png" className="w-screen" />
          <div className="h-6" />
          <div className="hidden md:flex px-4 lg:px-10 w-full">
            <div className="flex flex-row w-full items-baseline">
              <div className="h-6" />
